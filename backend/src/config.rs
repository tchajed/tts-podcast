...
impl AppConfig {
    pub fn from_env() -> Self {
        ...
        if openai_api_key.is_none() && elevenlabs_api_key.is_none() {
            panic!("At least one of OPENAI_API_KEY or ELEVENLABS_API_KEY must be set");
        }
        ...
        Self {
            ...
            openai_voice: env::var("OPENAI_VOICE")
